...
The combination of documentation, specalized search and integrated browsing allows **NextRole** to update your journal with useful context.  As you add notes and **NextRole** automatically adds analytics, the documentation grows more informative over time, creating a virtuous cycle that makes it an even stronger resource tomorrow.
